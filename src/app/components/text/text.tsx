...
export const H1 = ({ children, color, ...props }: any) => {
    return (
        <motion.h1 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[20px] md:text-[80px] " + color}>{children}</motion.h1>
    )
}
export const H2 = ({ children, color, ...props }: any) => {
    return (
        <motion.h2 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[16px] md:text-[55px] font-bold " + color}>{children}</motion.h2>
    )
}

export const H3 = ({ children, color, ...props }: any) => {
    return (
        <motion.h3 {...props} variants={RevealTextAfterSection} className={"text-[12px] lg:text-[22px] 2xl:text-[35px] " + color}>{children}</motion.h3>
    )
}
export const H5 = ({ children, color, ...props }: any) => {
    return (
        <motion.h5 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[12px] md:text-[25px] " + color}>{children}</motion.h5>
    )
}
export const B1 = ({ children, color, ...props }: any) => {
    return (
        <motion.p {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[12px] md:text-[28px] " + color}>{children}</motion.p>
    )
}
export const B2 = ({ children, color, ...props }: any) => {
    return (
        <motion.p {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[8px] md:text-[15px] 2xl:text-[21px] " + color}>{children}</motion.p>
    )
}
