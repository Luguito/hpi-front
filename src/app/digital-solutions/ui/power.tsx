...
// glow
import ngGenVeronica from '../../../../public/digital-solutions/expandable-icons/ngen-veronica.png'
import GMCS from '../../../../public/digital-solutions/expandable-icons/gcms.svg'
import HPDX from '../../../../public/digital-solutions/expandable-icons/logo_hpdx.png'
import DD from '../../../../public/digital-solutions/expandable-icons/dd.png'
import UBI from '../../../../public/digital-solutions/expandable-icons/ubi.png'
import AGOS from '../../../../public/digital-solutions/expandable-icons/agos.png'
import WMS from '../../../../public/digital-solutions/expandable-icons/wms.png'
import PARIS from '../../../../public/digital-solutions/expandable-icons/paris.png'
    ...
    return (
        <>
            ...
            <section className="flex flex-col gap-6 mt-5 bg-hpi-white rounded-3xl p-5 lg:p-20 xl:mt-10">
                <ExpandedComponent icon="digital-solutions/terminal.svg" title={"TERMINAL OPERATING SYSTEM (TOS)"} id="e-1">
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 gap-10">
                        <StorageImageClient width={355} height={89} name="digital-solutions/expandable-icons/ngen-veronica.png" alt="" className="hidden lg:block" />
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 gap-10 lg:mt-10">
                        <StorageImageClient  width={90} height={89} name="digital-solutions/expandable-icons/gcms.svg" className="hidden justify-self-center lg:block" />
                        <B2 color="font-medium text-hpi-grey-dark mt-4">
                            <b className="font-bold">TOS for General Cargo Operations:</b>  GCMS
                        </B2>
                    </section>
                </ExpandedComponent>
                <ExpandedComponent icon="digital-solutions/digitising.svg" title={"DIGITALISATION"} id="e-2">
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={475} height={117} name="digital-solutions/expandable-icons/logo_hpdx.png" className="hidden lg:block" />
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={126} height={56} name="digital-solutions/expandable-icons/dd.png" className="hidden lg:block ml-14" />
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={152} height={63} name="digital-solutions/expandable-icons/ubi.png" className="hidden lg:block ml-10" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-4 ">
                ...
                <ExpandedComponent icon="digital-solutions/productivity.svg" title={"AUTOMATION"} id="e-3">
                    <B2 color="font-medium text-hpi-grey-dark">
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={355} height={89} name="digital-solutions/expandable-icons/ngen-veronica.png" className="hidden lg:block" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-4">
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={125} height={44} name="digital-solutions/expandable-icons/agos.png" className="hidden justify-self-center lg:block" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-4">
                            <b className="font-bold">Gate Automation</b>
                        </B2>
                    </section>
                </ExpandedComponent>
                <ExpandedComponent icon="digital-solutions/logistics.svg" title={"LOGISTICS OPTIMISATION"} id="e-4">
                    <B2 color="font-medium text-hpi-grey-dark">
                    ...
                    <section className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] items-center p-5 mt-3 gap-10 lg:mt-10">
                        <StorageImageClient width={115} height={79} name="digital-solutions/expandable-icons/paris.png" className="hidden lg:block justify-self-center" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-4">
            ...
            initial="hidden" whileInView="visible" variants={RevealFromLeftToRight} viewport={{ once: true }}>
                <summary className="expansion-summary flex items-center gap-3 lg:gap-20 cursor-pointer" onClick={checkDetails}>
                    <article className='w-[5%] flex items-center justify-center'>
                        <StorageImageClient name={icon} alt="Icon" width={props.id === 'e-1' ? 80 : 50} height={100} priority />
                    </article>
