...
export const H1 = ({ children, color, ...props }: any) => {
    return (
        <motion.h1 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"xs:text-[20px] text-[80px] " + color}>{children}</motion.h1>
    )
}
export const H2 = ({ children, color, ...props }: any) => {
    return (
        <motion.h2 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"xs:text-[16px] text-[55px] font-bold " + color}>{children}</motion.h2>
    )
}

export const H3 = ({ children, color, ...props }: any) => {
    return (
        <motion.h3 {...props} variants={RevealTextAfterSection} className={"xs:text-[12px] text-[35px] " + color}>{children}</motion.h3>
    )
}
export const H5 = ({ children, color, ...props }: any) => {
    return (
        <motion.h5 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"xs:text-[12px] text-[25px] " + color}>{children}</motion.h5>
    )
}
export const B1 = ({ children, color, ...props }: any) => {
    return (
        <motion.p {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"xs:text-[12px] text-[28px] " + color}>{children}</motion.p>
    )
}
export const B2 = ({ children, color, ...props }: any) => {
    return (
        <motion.p {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"xs:text-[8px] text-[21px] " + color}>{children}</motion.p>
    )
}
