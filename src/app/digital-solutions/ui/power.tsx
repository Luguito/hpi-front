            ...
            <section className="flex flex-col gap-6 mt-5 bg-hpi-white rounded-3xl p-5 lg:p-20 lg:mt-16">
                <ExpandedComponent icon={Icon1} title={"TERMINAL OPERATING SYSTEM (TOS)"} onClick={getRef} id="e-1" isExpanded={expanded['e-1']} ref={ref}>
                    ...
                    <section className="flex items-center lg:ml-20 lg:mt-10">
                        <Image src={GMCS} alt="" height={50} className="hidden lg:block" />
                        <B2 color="font-medium text-hpi-grey-dark mt-4 lg:ml-44">
                ...
                <ExpandedComponent icon={Icon2} title={"DIGITALISATION"} onClick={getRef} id="e-2" isExpanded={expanded['e-2']}>
                    ...
                    <section className="flex items-center mt-3 lg:mt-10 lg:ml-3">
                        <Image src={HPDX} alt="" width={250} className="hidden lg:block" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-7 lg:ml-24">
                    ...
                    <section className="flex items-center mt-3 lg:mt-10">
                        <Image src={UBI} alt="" width={300} className="hidden lg:block ml-10" />
                        <B2 color="font-medium text-hpi-grey-dark lg:mt-4 lg:ml-[10.5rem]">
...
const ExpandedComponent = ({ icon, title, isExpanded, children, ...props }: any) => {
    ...
    return (
        <>
            <motion.details className="mb-0 lg:mb-10" {...props} initial="hidden" whileInView="visible" variants={RevealFromLeftToRight} viewport={{ once: true }} open>
                <summary className="expansion-summary flex items-center gap-3 lg:gap-20 cursor-pointer">
