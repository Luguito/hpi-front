...
export const H1 = ({ children, color, ...props }: any) => {
    return (
        <motion.h1 {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[20px] xl:text-[40px] 2xl:text-[80px] leading-[26px] xl:leading-[50px] 2xl:leading-[80px] " + color}>{children}</motion.h1>
    )
}
...
export const H3 = ({ children, color, ...props }: any) => {
    return (
        <motion.h3 {...props} variants={RevealTextAfterSection} className={"text-[16px] lg:text-[22px] xl:text-[30px] 2xl:text-[35px] " + color}>{children}</motion.h3>
    )
}
...
export const B2 = ({ children, color, ...props }: any) => {
    return (
        <motion.p {...props} variants={RevealTextAfterSection} viewport={{ once: true }} className={"text-[13px] md:text-[15px] xl:text-[15px] 2xl:text-[21px] " + color}>{children}</motion.p>
    )
}
